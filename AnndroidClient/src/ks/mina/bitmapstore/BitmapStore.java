...
public class BitmapStore {
	...
	private static boolean isGetPicture=false;//全局变量
	 
	 
	 
	public static synchronized void setisGetPicture(boolean bl)
	{
		isGetPicture=bl;
	   
	}
	public static synchronized boolean getisGetPicture()
	{
		return isGetPicture;
	}
