...
public class Activity_VideoStream extends Activity {
	...
	{
		Intent notificationIntent = new Intent(this, Activity_VideoStream.class);
...
private void upDateRemoteEyeApplicationInfo()
{
	...
	private void setStateDescription(String states)
	{
		...
		case 2: // '\002'
			...
			String str=String.format("Open VLC and key in the address:\nrtsp://%s/%s.sdp", aobj);
			textViewVLCAddress.setText(str);
			str=String.format("rtsp://%s/%s.sdp", aobj);
			PacketData pd=PacketDataOperate.sendStrPacketData(GlobalContent.YOURVIDEOSTREAM+GlobalContent.separator+USERIP+GlobalContent.separator+str);
	...
	private void openSharePreferenceActivity()
	{
		...
		sharepreferenceIntent.setClass(Activity_VideoStream.this, PreferencesActivity.class);
