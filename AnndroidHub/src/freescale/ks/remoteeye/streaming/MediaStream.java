...
package freescale.ks.remoteeye.streaming;
...
import freescale.ks.remoteeye.streaming.audio.AudioStream;
import freescale.ks.remoteeye.streaming.rtp.AbstractPacketizer;
import freescale.ks.remoteeye.streaming.video.VideoStream;
...
public abstract class MediaStream implements Stream {
	...
	protected byte mChannelIdentifier;
	...
	public void setOutputStream(OutputStream outputstream, byte byte0)
	{
		mOutputStream = outputstream;
		mChannelIdentifier = byte0;
	}
	 ...
	 * {@link VideoStream#setVideoQuality(freescale.ks.remoteeye.streaming.video.VideoQuality)}
	 * for a {@link VideoStream} and {@link AudioStream#setAudioQuality(freescale.ks.remoteeye.streaming.audio.AudioQuality)}
	...
	public synchronized void start() throws IllegalStateException, IOException {
		...
		Log.e(TAG, "........MediaStream.start().........");
		if (mDestination==null)
		{
			Log.e(TAG, "........no mDestination.........");
			throw new IllegalStateException("No destination ip address set for the stream !");
		}

		if ((mRtpPort<=0 || mRtcpPort<=0) && mOutputStream == null)
		{
			Log.e(TAG, "........no ...........");
		...
		if (mMode != MODE_MEDIARECORDER_API) {
			Log.e(TAG, ".......encodeWithMediaCodec()..........");
			encodeWithMediaCodec();
		} else {
			Log.e(TAG, ".......encodeWithMediaRecorder()..........");
	...
	/**
	 * Returns the SSRC of the underlying {@link freescale.ks.remoteeye.streaming.rtp.RtpSocket}.
